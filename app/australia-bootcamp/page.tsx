...
const BootcampForm = () => {
  ...
  const onSubmit = async (data: any) => {
    ...
    const base = new Airtable({ apiKey: 'patUhv5YguOE9DH1W.01bedb105f187fd2b320ce73fc31d5a556e2aefc88cd41f7113d9f58e014fcbe' }).base('appvnLyicFQhcjEOP');

    base('Bootcamp Registrations').create([
      {
        fields: {
          ...data
        }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg bg-white p-8 rounded-lg shadow-lg">
...

        {
          step === 4 && (
            <>
              ...
              <p className="mb-6">Please provide details of two emergency contacts</p>

              <h4 className="text-base font-semibold mb-2">Primary Emergency</h4>
              ...
              <h4 className="text-base font-semibold mb-2">Secondary Emergency</h4>
          ...
          step === 5 && (
            <>
              ...
              <div className="mb-4">
                ...
                <input
                  type="number" min="1900" max={new Date().getFullYear()} defaultValue={new Date().getFullYear()}
...

        {
          step === 6 && (
            <>
              ...
              <div className="mb-4">
                <h4 className="text-lg font-semibold border-b border-gray-300 mb-2">Boot's Information</h4>
              ...
              <div className="mb-4">
                <h4 className="text-lg font-semibold border-b border-gray-300 mb-2">Parent / Guardian Information</h4>
              ...
              <div className="mb-4">
                <h4 className="text-lg font-semibold border-b border-gray-300 mb-2">Church Information</h4>
              ...
              <div className="mb-4">
                <h4 className="text-lg font-semibold border-b border-gray-300 mb-2">Emergency Contact</h4>
              ...
              <div className="mb-4">
                <h4 className="text-lg font-semibold border-b border-gray-300 mb-2">Health History</h4>
...

        {
          step === 7 && (
            <div>
              <h3 className="text-xl font-semibold mb-4">Thank you for submission</h3>
              <p className="mb-4">We will process the information & inform you as soon as possible.</p>
            </div>
          )
        }
        ...
        {submissionError && <div className="my-4 text-red-600">Error submitted the form. Please contact us.</div>}
      </form >
    </div >
  );
};
